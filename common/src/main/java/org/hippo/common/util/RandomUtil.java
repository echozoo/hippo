...
public class RandomUtil {
    ...
    public static void main(String[] Args) {
        String s1 = getRandomALLChar(5);
        String s2 = getRandomLetterChar(5);
        String s3 = getRandomLowerLetterChar(5);
        String s4 = getRandomNumberChar(6);
        String s5 = getRandomNumberLowerLetterChar(6);
        String s6 = getRandomNumberUpperLetterChar(6);
        String s7 = getRandomUpperLetterChar(6);
    }
}
