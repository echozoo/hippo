 ...
 * @since JDK1.8
 */
public class SinaUserInfoTokenServices implements ResourceServerTokenServices {
  ...
  private Map<String, Object> getMap(String path, String accessToken) {
    ...
    try {
      ...
      path = path + "?uid=" + existingToken.getAdditionalInformation().get("uid") + "&access_token=" + existingToken.getValue();
      logger.info(existingToken.getAdditionalInformation().toString());
